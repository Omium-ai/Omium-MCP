...
| Observability     | `get_observability_metrics`, `get_observability_metrics_summary`, `get_observability_metrics_prometheus`, `list_observability_traces`, `list_alerts`, `list_alerts_history`, `get_observability_dashboard`, `get_observability_health` |
...
`get_observability_trace`, `get_observability_trace_summary`,
`acknowledge_alert`, `get_trace`, `list_project_files`, `commit_project_git`,
